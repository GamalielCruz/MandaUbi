...
export default function Examples() {
  ...
  >
    <div className="relative flex flex-col items-center gap-8 max-w-screen-lg mx-auto">
      <div className="max-w-xs lg:max-w-md w-full flex justify-center overflow-hidden">
        <img
          className="w-full h-auto rounded-md object-cover object-top" data-aos="fade-left" data-aos-delay="700"
      ...
      <h1 className="text-gray-50 text-center font-mono text-4xl" data-aos="fade" data-aos-delay="300">MIS XV AÑOS</h1>
      <h1 className="text-5xl text-gray-50 font-serif font-bold text-center" data-aos="fade" data-aos-delay="300">Brenda</h1>
      <p className="text-2xl text-white text-center font-mono" data-aos="fade" data-aos-delay="300">26 / DIC / 2024</p>

      <div className="max-w-xs lg:max-w-md w-full flex justify-center overflow-hidden" data-aos="fade-right" data-aos-delay="700">
        <img
      ...
      <div className="relative flex justify-center p-5" data-aos="zoom-in" data-aos-duration="1000"> 
  ...
  <div className="flex justify-center items-center  mt-6 bg-orange-950 aspect-square" data-aos="fade-up" data-aos-delay="600">
